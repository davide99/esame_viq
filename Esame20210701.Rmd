...
data <-
  ...
  mutate(Bln_barili=if_else(is.na(Bln_barili), 107*Percentuale/6.2 ,Bln_barili))
...
renderPlot({
  ...
  if (tipo_grafico() == 'Pareto'){
    ...
    ggplot(waffle_data, aes(x, y, fill = group)) + 
      ...
      discrete_scale(aesthetics = "fill", scale_name = "waffle", palette=waffle_pal()) +
      scale_y_discrete(expand = expansion(mult = 0.2))+
      ylab("1 quad = 10 bilioni di barili") +
      theme_waffle() +
      theme(
